    ...
    <div className='main__services'>
      <div className="main__services__item">
        ...
        <div className="main__services__item__text">
          Благодаря UV-защиете, солнечный свет не разрушает полимерные связи, вследствие чего поликабонат не теряет свои первоначальные характеристики – пластичность, устойчивость к механическому воздействию, несущую способность, цвет.
        </div>
      </div>
      <div className="main__services__item">
        <div className="main__services__item__img">
